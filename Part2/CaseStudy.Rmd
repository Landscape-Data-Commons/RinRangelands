...
This section of the notebook runs using two sample areas of interest for the Sandy Ecological Site Group, but you can run similar analysis for any shapefile. We will import the shapefile as an sf object and upload it to Google Earth Engine and then visualize the Sandy ESG on a leaflet map using the mapview package. 
