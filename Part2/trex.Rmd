...
kableExtra::scroll_box(kableExtra::kable_styling(knitr::kable(x = head(jer_indicators),
                                                              format = "html",
                                                              caption = "The indicator results for the Jornada Experimental Range"),
                                                 bootstrap_options = "striped"),
                       height = "400px",
                       width = "100%")
kableExtra::scroll_box(kableExtra::kable_styling(knitr::kable(x = head(jer_lpi),
                                                              format = "html",
                                                              caption = "The raw LPI data results for the Jornada Experimental Range"),
                                                 bootstrap_options = "striped"),
                       height = "400px",
                       width = "100%")
```
...
knitr::kable(head(mlra_036x_headers))
```
...
knitr::kable(head(mlra_036_lowcover_soil))
```
